...
def poe_mcq_predict(
    ...
    One-shot aggregator: prefill the prompt, compute the PoE distribution over
    all heads at the last prompt position, and argmax over the {A, B, C, D}
    token ids. Deterministic by construction (no draft sampling, no rejection).
